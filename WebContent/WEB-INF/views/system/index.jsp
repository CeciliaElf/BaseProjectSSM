...
<body class="easyui-layout">
	<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:20%;">
		 <img src="../resources/admin/easyui/images/loading.gif" width="100px">
	     <h1>
	     	<font color="#124BBF">正在加载中....</font>
	     </h1>
	</div> 
	<!-- begin of header -->
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
            ...
            <p><a href="#">网站首页</a>|<a href="#">支持论坛</a>|<a href="#">帮助中心</a>|<a href="${pageContext.request.contextPath}/system/logout">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
    ...
    <div class="wu-main" data-options="region:'center'">
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            <div title="首页" data-options="href:'${pageContext.request.contextPath}/system/welcome',closable:false,iconCls:'icon-tip',cls:'pd3'"></div>
        </div>
    </div>
    <!-- end of main --> 
    <!-- begin of footer -->
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2025 Cecilia All Rights Reserved
    </div>
    <!-- end of footer -->  
